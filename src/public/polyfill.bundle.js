...
_export(_export.G + _export.F * (parseInt != _parseInt$2), { parseInt: _parseInt$2 });
...
_export(_export.G + _export.F * (parseFloat != _parseFloat$2), { parseFloat: _parseFloat$2 });
...
_export(_export.S + _export.F * (Number.parseFloat != _parseFloat$2), 'Number', { parseFloat: _parseFloat$2 });

// 20.1.2.13 Number.parseInt(string, radix)
_export(_export.S + _export.F * (Number.parseInt != _parseInt$2), 'Number', { parseInt: _parseInt$2 });
...
var _collectionStrong = {
  getConstructor: function (wrapper, NAME, IS_MAP, ADDER) {
    ...
    if (_descriptors) dP$6(C.prototype, 'size', {
      get: function () {
...
_export(_export.S, 'Reflect', {
  deleteProperty: function deleteProperty(target, propertyKey) {
    var desc = gOPD$4(_anObject(target), propertyKey);
